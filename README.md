...
- Une table des géométries des objects à représenter (ex.: communes d'alsace = "COMMUNES_ALSACE"). Elle doit contenir outre la géométrie, au minimum:
    - Un champ de jointure (ex.: PK = code INSEE des communes = "CODE_INSEE")
- Une table des données temporelles (ex.: qualité de l'air des commmunes d'Alsace = "IQA_COMMUNES_ALSACE"). Elle doit contenir au minimum: 
